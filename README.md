...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lively-wildflower-0d60)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lively-wildflower-0d60
```

A live public deployment of this template is available at [https://lively-wildflower-0d60.templates.workers.dev](https://lively-wildflower-0d60.templates.workers.dev)
